...
<%@page import="com.biddingapp.pojo.Order"%>
                              ...
                              <div class='panel-body'>
                              	<%
                              		...
                              		if (orders==null || orders.size()==0) {
                              			%>
                              				<h5><strong>No Orders have been Placed for you yet.</strong></h5>
                              			<%
                              		} else {
                              			%>
                              				<table class='table table-hover' >
                              					...
                              					<%
                              						...
                              						for (Order o : orders) {
                              							i++;
                              							Product p = products.get(o.getPid());
                              							%>
                              								<tr>
                              									<td> <%=o.getPid() %></td>
                              									<td> <%=p.getPname() %>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><%=p.getPname() %></h4>
      </div>
