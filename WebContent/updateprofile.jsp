            ...
            <nav class="navbar navbar-static-top" role="navigation">
                ...
                <a href="#" class="navbar-btn sidebar-toggle" data-toggle="offcanvas" role="button">
                    ...
                    <span class="icon-bar"></span>
               		...
               		<a  class="navbar-btn sidebar-toggle" ><strong ><%=user.getRole() %> Portal</strong></a>
                              ...
                              <div class="panel-body">
									...
									<% } %>
										...
										<form action='user' method=post >
											...
											<input type=text readonly="readonly" class='form-control' name='email' placeholder='Email ID' value='<%=user.getEmail()%>'/>
											<br/>
											...
											<input type=text class='form-control' name='fname' placeholder='First name' value='<%=user.getFname()%>' />
											<br/>
											
											<label>
												Enter your Last name
											</label>
											<input type=text class='form-control' name='lname' placeholder='Last name' value='<%=user.getLname()%>' />
											<br/>
											...
											<input type=text class='form-control' name='mobile' placeholder='Mobile number' value='<%=user.getMobile()%>'/>
											<br/>
											...
											<br/>
											<input type=submit value='Update Profile' class='btn btn-primary' style='color: white;' />
										</form>                              
									</div>
