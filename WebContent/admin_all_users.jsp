                              ...
                              <div class='panel-body'>
											...
											<%
												...
												if (users==null || users.size()==0) {
													%>
														<h5>No Users require Membership Approval at this moment.</h5>
													<%
												} else {
											%>
											...
											<%
												for (User u : users) {
													...
													<div class="panel panel-default">
													  ...
													  <div class="panel-body">
													    <form action='membership' method=post class='col-md-4'>
													    	<input type=hidden name='type' value='reject' />
													    	<input type=hidden name='email' value='<%=u.getEmail() %>' />
													    	<input type=hidden name='role' value='<%=role %>' /> 
													    	<input type=submit class='btn btn-danger form-control' value='Remove this User' />
													    </form>
													  </div>
													</div>
													</div>
