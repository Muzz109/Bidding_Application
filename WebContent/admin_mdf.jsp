                              ...
                              <div class='panel-body'>
											...
											<%
												...
												if (topics==null || topics.size()==0) {
													%>
														<h3>No Topics has been created so far</h3>
													<%
												} else {
													%>
														...
														<table class='table'>
															...
															%>
																...
																<tr>
																	...
																	<td> <%=d.getCreater() %></td>
																	<td> <%=sdf.format(d.getEntrytime())%></td>
																	<td> <a href='#' data-toggle="modal" data-target="#topic<%=i%>"> <span class='glyphicon glyphicon-remove'></span></a>
																	
<!-- Modal -->
<div class="modal fade" id="topic<%=i%>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel"><%=d.getSub() %></h4>
      </div>
      <div class="modal-body">
        Are you sure you want to remove this Topic ?
      </div>
      <form action='manageDF'>
      	<input type=hidden name='type' value='delete' />
      	<input type=hidden name='id' value='<%=d.getTopicid() %>' />
