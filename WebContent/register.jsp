                        ...
                        <section class="sidebar">
                            ...
                            <div class="user-panel">
                                ...
                                <div class="pull-left info">
                                    ...
                                    <a href="#"><i class="fa fa-circle text-failure"></i> You are offline</a>
                                </div>
                            </div>
							 ...
							 <section class="panel">
                              ...
                              <div class="panel-body">
										...
										<form action='user' method=post >
												...
												<textarea class='form-control' name='addr' placeholder='Address'></textarea>
												<br/>
												
												<input type=checkbox name='terms' /> I agree for <a href='#' data-toggle="modal" data-target="#terms">Terms and Conditions</a>
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
												...
												<input type=submit value='Register' class='btn btn-primary' style='color: white;'/>
											</form>   
