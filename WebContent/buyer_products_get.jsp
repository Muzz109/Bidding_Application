                              ...
                              <div class='panel-body'>
											...
											<% 
												...
												if (products ==null || products.size()==0) {
													%>
														<h4>No products are available in this portal at this moment</h4>
													<%
												} else {
													%>
														<ul class="list-group">
																  						...
																  						<td>
																  							<%
																  								...
																  								if (deadline.after(currenttime)) {
																  									%>
																  									<a href='bid?type=view&pid=<%=p.getPid() %>' class='btn btn-warning'><span class='glyphicon glyphicon-play-circle'></span> Bid this Product</a>
